...
{:else}
  <select
    class="bg-white border rounded border-gray-300 text-xs leading-tight w-full py-2 px-3 appearance-none !pr-8 lg:w-60  dark:bg-gray-700 dark:border-gray-600 focus:outline-none focus:shadow-outline"
