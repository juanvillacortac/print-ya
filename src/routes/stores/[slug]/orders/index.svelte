...
<script lang="ts">
  ...
  export let orders: StrippedOrder[] | undefined
      ...
      (products
        ? order.items
            ...
            .map(
              (i) =>
                (i.product
                  ? getTotalFromProductModifiers(i.product, i.modifiers)
                  : 0) * i.quantity
            )
            .reduce((a, b) => a + b, 0)
        : 0)
                ...
                >
                  ...
                  <td class="py-4 px-6">
                    <div class="flex">
                      <p
                        class="rounded bg-gray-100 text-xs p-1 whitespace-nowrap overflow-ellipsis uppercase dark:bg-gray-600"
                        class:!bg-green-500={o.fulfillmentStatus ===
                          'fulfilled'}
                        class:!text-white={o.fulfillmentStatus === 'fulfilled'}
                      >
                        {o.fulfillmentStatus.split('_').join(' ')}
