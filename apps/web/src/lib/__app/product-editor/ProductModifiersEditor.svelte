...
<div
  class="border rounded-lg flex flex-col h-full space-y-4 border-gray-300 w-full p-4 dark:border-gray-700"
>
      ...
      >
        <div class="flex flex-col w-full">
          ...
          >
            ...
            {#if modifierTypes?.find((t) => t.type === m.type)?.embeddable && accessors}
              <div class="flex flex-col w-full">
                <label class="flex flex-col space-y-2">
