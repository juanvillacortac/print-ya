    ...
    <div class="flex flex-grow flex-col h-full space-y-4 w-full">
      {#if items?.length}
        ...
        <div class="flex space-x-4 w-full justify-end items-center">
          ...
          {/if}
          <button
            class="bg-$sc-color-primary rounded flex font-bold space-x-2 shadow text-white text-xl py-4 px-4 transform duration-200 items-center disabled:(cursor-not-allowed opacity-50) hover:not-disabled:scale-105 "
