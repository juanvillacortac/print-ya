...
import type { NodeHTTPCreateContextOption } from '@trpc/server/dist/declarations/src/adapters/node-http/types.js'
import type {
  HTTPBaseHandlerOptions,
  HTTPRequest,
} from '@trpc/server/dist/declarations/src/http/internals/types.js'
